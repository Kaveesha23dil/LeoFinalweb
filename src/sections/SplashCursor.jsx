...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    canvas.addEventListener('mousemove', function handleFirstMouseMove(e) {
      const rect = canvas.getBoundingClientRect();
      let pointer = pointers[0];
      let posX = scaleByPixelRatio(e.clientX - rect.left);
      let posY = scaleByPixelRatio(e.clientY - rect.top);
    ...
    canvas.addEventListener('touchstart', function handleFirstTouchStart(e) {
      const rect = canvas.getBoundingClientRect();
      ...
      canvas.removeEventListener('touchstart', handleFirstTouchStart);
    });
  ...
  return (
    <div className="absolute top-0 left-0 z-10 pointer-events-auto w-full h-full">
